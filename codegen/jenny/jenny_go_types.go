...
import (
	...
	"github.com/grafana/kindsys/codegen"
	"github.com/grafana/thema/encoding/gocode"
	"github.com/grafana/thema/encoding/openapi"
)

// GoTypesJenny is a [codegen.OneToOne] that produces Go types for the provided
// [thema.Schema].
...
func (j GoTypesJenny) Generate(sfg codegen.SchemaForGen) (*codejen.File, error) {
	...
	b, err := gocode.GenerateTypesOpenAPI(sfg.Schema, &gocode.TypeConfigOpenAPI{
		...
		ApplyFuncs:  append(j.ApplyFuncs, codegen.PrefixDropper(sfg.Name)),
	})
